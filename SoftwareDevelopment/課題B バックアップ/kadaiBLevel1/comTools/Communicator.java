...
public class Communicator {
     ...
     * @throws IOException
     */
    public static kobeU.cs.kadaiB.kadaiBLevel1.comTools.Communicator startConnectionAsClient(String hostname, int portNum) throws IOException {
        /* IP address の取得 */
        ...
        return new kobeU.cs.kadaiB.kadaiBLevel1.comTools.Communicator(socket);
    }
    /**
     ...
     * @throws IOException
     */
    public static kobeU.cs.kadaiB.kadaiBLevel1.comTools.Communicator startConnectionAsServer(int portNum) throws IOException {
    ...
    public Object recv() throws IOException, ClassNotFoundException {
        synchronized(in) {
            ...
            try {
                ...
                if(obj instanceof kobeU.cs.kadaiB.kadaiBLevel1.comTools.Communicator.TerminateMsg) {
                    inIsClosed=true;
                    if(!outIsClosed) {
                        this.startClosing();
                    }
    ...
    public void startClosing() {
        synchronized(out) {
            ...
            try {
                outIsClosed=true;
                out.writeObject(new kobeU.cs.kadaiB.kadaiBLevel1.comTools.Communicator.TerminateMsg());
                out.flush();
                //out.close();
            } catch(IOException e) {
                closeAll();
