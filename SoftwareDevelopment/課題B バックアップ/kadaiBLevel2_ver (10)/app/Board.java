...
public class Board extends JFrame {
            ...
            */
            customView.addMouseMotionListener(new MouseMotionAdapter() {
                ...
                public void mouseDragged(MouseEvent e) {
                    ...
                    manager.sendPoints(customView.getPoints());
                }
            });
    ...
    private JPanel getRightUnderPane() {
        if (rightUnderJContentPane == null) {
            ...
            colorChoice.setMaximumSize(new Dimension(400, 40));
            colorChoice.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {
                    customView.setPenColor(colorChoice.getSelectedItem());
                    manager.changeColor(colorChoice.getSelectedItem());
                }
            });
            rightUnderJContentPane.add(colorChoice, null);
            ...
            widthChoice.add("10");
            widthChoice.add("20");
            widthChoice.setMaximumSize(new Dimension(400, 40));
            widthChoice.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {
                    customView.setPenWidth(widthChoice.getSelectedItem());
                    manager.changeWidth(widthChoice.getSelectedItem());
                }
            });
            rightUnderJContentPane.add(widthChoice, null);
    ...
    */
    public void recvPoints(ArrayList<Integer> points) {
        customView.recvPointsList(points);
    }
/*
 ...
 */
    ...
    public void changePenWidth(String width) { customView.setPenWidth(width); }
    @Override
