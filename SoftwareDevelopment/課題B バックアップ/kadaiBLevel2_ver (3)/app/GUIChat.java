...
import kobeU.cs.kadaiB.kadaiBLevel2.app.CustomView;
...
public class GUIChat {
        ...
        try {
            ...
            while(true) {
                ...
                if(msg==null) {
                    ...
                    if(msg.body.equals("undo")) {
                        board.undoPressed();
                    } else if(msg.body.equals("reset")) {
                        board.resetPressed();
                    } else {
                    ...
                    board.recvRectangle((Rectangle) msg.body);
                }
    ...
    public void sendMsg(String text)  {
        ...
        if(comm==null) {
            ...
            try {
                ObjMessage msg =new ObjMessage(text);
                comm.send(msg);
    ...
    public void sendRect(Rectangle rect)  {
        assert(SwingUtilities.isEventDispatchThread());
        if(comm==null) {
            displaySysMsg("not connected.");
        }
            ...
            try {
                ObjMessage msg = new ObjMessage(rect);
                comm.send(msg);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void undoButton() {
        ...
        if(comm==null) {
            ...
            try {
                ObjMessage msg = new ObjMessage("undo");
                comm.send(msg);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void resetButton() {
        ...
        if(comm==null) {
            ...
            try {
                ObjMessage msg = new ObjMessage("reset");
                comm.send(msg);
            } catch (IOException e) {
                e.printStackTrace();
            }
