...
import kobeU.cs.kadaiBsubmit.comTools.Communicator;
...
public class SetupDialog extends JDialog{
    ...
    private JPanel getJContentPane() {
        if (jContentPane == null) {
            ...
            jContentPane.add(getJPanel0(), null);
    ...
    private JPanel getJPanel0() {
        if (jPanel0 == null) {
            ...
            jLabel0.setPreferredSize(new Dimension(70, 20));
            jPanel0 = new JPanel();
            jPanel0.setLayout(new BoxLayout(getJPanel0(), BoxLayout.X_AXIS));
            jPanel0.add(jLabel0, null);
            jPanel0.add(getUsernameTextField(), null);
        }
        return jPanel0;
    }
    ...
    private JTextField getUsernameTextField() {
        if (usernameTextField == null) {
            ...
            usernameTextField.setText("YourName");
